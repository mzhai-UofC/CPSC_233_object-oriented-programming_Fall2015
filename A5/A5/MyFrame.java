 ...
 * 
 *           The shopping frame cointains several components, thay are:
 *           -a JTextField and JTextArea for the name and address input areas.
 *           -Jlabels to describe the input fields.
 *           -two JButtons to handle most of the user interaction.
 *           -a image in the container with an appropriate company logo.
 *
 * Limitation:-The textArea frame for the address does not have a static shape when the input of the texts
 *             exceed the length of the frame. 
 */

public class MyFrame extends JFrame implements ActionListener
{
	//Creating a textField for the inputs of name.
    private JTextField text1;
    //Creating a textAreas for the inputs of address.
    ...
    public void actionPerformed(ActionEvent e)
    {
    	...
    	if(e.getSource()==aButton1){
            ...
            output();
            //A method that changing the windows title when pressing the "save" button for 3s.
            delay();
    	}
   ...
   //Adding the icon to the "clear" button.
    ...
    //A method that changing the windows title when pressing the "save" button for 3s.
    private void delay(){
    	setTitle("The text is saving(3s...).");
    	 try 
         {
